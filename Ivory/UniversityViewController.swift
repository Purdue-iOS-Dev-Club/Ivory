...
//  Ivory
//
//  Created by Nikhil Nandkumar on 2/9/16.
...
class UniversityViewController: UITableViewController {
    ...
    var universityNames = ["Purdue University","Indiana University Bloomington","University of Illinois Urbana-Champaign"]
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.nameLabel.text =  universityNames[indexPath.row]
    ...
    override func tableView(tableView: UITableView, heightForHeaderInSection section: Int) -> CGFloat {
        ...
        return CGFloat(Float(universityNames.count) * Float(self.tableView.rowHeight))
    }
